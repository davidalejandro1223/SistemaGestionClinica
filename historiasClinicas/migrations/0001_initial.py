# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-10-15 04:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examen_actual', models.CharField(choices=[('preingreso', 'Pre-ingreso'), ('periodico', 'Periodico'), ('egreso', 'Egreso'), ('cambio labor', 'Cambio labor'), ('reincorporacion', 'Reincorporacion laboral'), ('rev paraclinicos', 'Rev. Paraclinicos')], max_length=50, verbose_name='Examen')),
                ...
                ('remite', models.CharField(choices=[('se remite EPS', 'Se remite a EPS'), ('continuar manejor medico EPS', 'Continuar manejo medio por EPS'), ('se remite ARL', 'Se remite a ARL')], max_length=50, verbose_name='Se remite a')),
